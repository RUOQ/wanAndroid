package com.ruoq.wanAndroid.mvp.ui.base
...
import com.ruoq.wanAndroid.app.utils.StatusBarUtil
...
abstract class BaseActivity<P:IPresenter>:SupportActivity(),IActivity,ActivityLifecycleable,IView {
    ...
    @Inject
    @JvmField
    var mPresenter:P ?= null //如果当前页面逻辑简单，Presenter可以为null

    @Synchronized
    override fun provideCache(): Cache<String, Any> {
        if(mCache == null){
            mCache = ArmsUtils.obtainAppComponentFromContext(this)
                .cacheFactory()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try{
            ...
            //如果initView 返回 0 ，则框架不会调用setContentView,当然也不会Bind ButterKnife
            if(layoutResId != 0){
